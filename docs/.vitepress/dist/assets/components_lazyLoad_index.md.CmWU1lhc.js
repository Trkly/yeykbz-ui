import{a7 as y,a3 as h,c as p,o as k,_ as u,F,C as m,m as i,h as v,D as C,H as a,a6 as b,a as l,a4 as E,p as t,w as e}from"./chunks/framework.DyjQ86ua.js";import{d as g,f as c}from"./chunks/index.GfJILXev.js";const B=`<template>\r
  <img\r
...
`,D={class:"custom-placeholder"},A={__name:"Lazyload_2",setup(d){return(n,r)=>{const s=y("lazyLoad");return h((k(),p("img",D,null,512)),[[s,"https://picsum.photos/300/200"]])}}},f=`<template>\r
...
`,x={},_={class:"scroll-container"},q={alt:"示例图片",class:"lazy-image"};function L(d,n){const r=y("lazyLoad");return k(),p("div",_,[(k(),p(F,null,m(20,s=>i("div",{key:s,class:"list-item"},[h(i("img",q,null,512),[[r,`https://picsum.photos/200/200?random=${s}`]])])),64))])}const z=u(x,[["render",L]]),Z=JSON.parse('{"title":"v-lazyLoad 图片懒加载指令","description":"","frontmatter":{},"headers":[],"relativePath":"components/lazyLoad/index.md","filePath":"components/lazyLoad/index.md"}'),w={name:"components/lazyLoad/index.md"},T=Object.assign(w,{setup(d){const n=v(!0);return(r,s)=>{const o=C("ClientOnly");return k(),p("div",null,[s[2]||(s[2]=i("h1",{id:"v-lazyload-图片懒加载指令",tabindex:"-1"},[l("v-lazyLoad 图片懒加载指令 "),i("a",{class:"header-anchor",href:"#v-lazyload-图片懒加载指令","aria-label":'Permalink to "v-lazyLoad 图片懒加载指令"'},"​")],-1)),s[3]||(s[3]=i("p",null,"用于实现图片的视口懒加载，优化页面加载性能。",-1)),s[4]||(s[4]=i("h2",{id:"基本用法",tabindex:"-1"},[l("基本用法 "),i("a",{class:"header-anchor",href:"#基本用法","aria-label":'Permalink to "基本用法"'},"​")],-1)),h(a(t(g),null,null,512),[[E,n.value]]),a(o,null,{default:e(()=>[a(t(c),{title:"",description:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[0]||(s[0]=()=>{n.value=!1}),vueCode:t(f)},{vue:e(()=>[a(z)]),_:1},8,["vueCode"])]),_:1}),s[5]||(s[5]=i("h2",{id:"自定义配置",tabindex:"-1"},[l("自定义配置 "),i("a",{class:"header-anchor",href:"#自定义配置","aria-label":'Permalink to "自定义配置"'},"​")],-1)),s[6]||(s[6]=i("h3",{id:"自定义占位符",tabindex:"-1"},[l("自定义占位符 "),i("a",{class:"header-anchor",href:"#自定义占位符","aria-label":'Permalink to "自定义占位符"'},"​")],-1)),h(a(t(g),null,null,512),[[E,n.value]]),a(o,null,{default:e(()=>[a(t(c),{title:"",description:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[1]||(s[1]=()=>{n.value=!1}),vueCode:t(B)},{vue:e(()=>[a(A)]),_:1},8,["vueCode"])]),_:1}),s[7]||(s[7]=b(`<h2 id="参数说明" tabindex="-1">参数说明 <a class="header-anchor" href="#参数说明" aria-label="Permalink to &quot;参数说明&quot;">​</a></h2><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>必需</th></tr></thead><tbody><tr><td>value</td><td>图片实际加载地址</td><td>string</td><td>是</td></tr></tbody></table><h2 id="实现特性" tabindex="-1">实现特性 <a class="header-anchor" href="#实现特性" aria-label="Permalink to &quot;实现特性&quot;">​</a></h2><ol><li><p><strong>智能加载</strong></p><ul><li>使用 <code>IntersectionObserver</code> API 实现</li><li>自动处理滚动容器检测</li><li>支持任何包含滚动容器的布局</li></ul></li><li><p><strong>性能优化</strong></p><ul><li>默认使用 1x1 透明占位图</li><li>加载完成后自动解除观察</li><li>组件卸载自动清理资源</li></ul></li><li><p><strong>视觉过渡</strong></p><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/* 推荐添加加载过渡效果 */</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">el.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">addEventListener</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;load&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, loadHandler)</span></span></code></pre></div>`,14))])}}});export{Z as __pageData,T as default};
